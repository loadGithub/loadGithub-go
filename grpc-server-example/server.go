...
func (s *server) SayHello(ctx context.Context, in *service.HelloRequest) (*service.HelloReply, error) {
	fmt.Println("SayHello方法请求JSON:" + in.Name)
	return &service.HelloReply{Message: "hello :" + fmt.Sprintf("%x", in.Name)}, nil
}

func (s *server) SayHelloAgain(ctx context.Context, in *service.HelloRequest) (*service.HelloReply, error) {
	fmt.Println("SayHelloAgain方法请求JSON:" + in.Name)
	return &service.HelloReply{Message: "hello again :" + fmt.Sprintf("%x", in.Name)}, nil
}
